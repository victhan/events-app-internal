...
const mockEvents = {
    events: [
        { title: 'an event', id: 1, description: 'something really cool', location: 'Victorias house', time: '4:00am' },
        { title: 'another event', id: 2, description: 'something even cooler', location: 'Mission NYC', time:'1:00am' }
    ]
};
